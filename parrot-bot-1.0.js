/*Parrot-Bot AKA memebot The Parrot 
...
bot.on('message', (message) => {//______________________HANDLING MESSAGE INPUT_______________________________
    ...
    /* Prevents memebot from entering his own messages into the database */
    if (!msg.includes("!memebot") && (!msg.includes('BEEPBOOP!') && (!msg[0].includes('!')))) {
...
bot.on("message", msg => { //______________________HANDLING COMMAND INPUT_______________________________
    ...
    if (msg.content.startsWith(prefix + "help")) {
        ...
        msg.channel.sendMessage("!memebot - Spew out a message generated from previous channel messages.");
    }
    /* Makes memebot speak */
    if (msg.content.startsWith(prefix + "memebot")) {
        getMessageParts();
        /* wipe local lists */
